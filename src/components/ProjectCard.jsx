...
function ProjectCard({ title, creationDate, description, documentUrl, videoUrl }) {
  // Construir URL de previsualización Google Drive
  ...
  return (
    <div className="max-w-full sm:max-w-4xl mx-auto bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg overflow-hidden mb-8">
      <div className="p-6 md:p-8">
        <h2 className="text-3xl font-semibold text-gray-900 dark:text-white">{title}</h2>
        <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Fecha de realización: {creationDate}</p>
        ...
        {!documentUrl && !videoUrl && (
          <p className="mt-6 text-gray-500 dark:text-gray-400">
            No hay documentos o videos disponibles para esta entrada.
          </p>
        )}
      </div>
    </div>
